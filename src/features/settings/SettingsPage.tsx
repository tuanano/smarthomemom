  ...
  return (
    <div className="scrollable" style={{ paddingBottom: '90px' }}>
      ...
      {view === 'notifications' && (() => {
        ...
        const Sw = ({ on, onToggle, light = false }: { on: boolean; onToggle: () => void; light?: boolean }) => (
          <button
            type="button"
        ...
        return (
          <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
            ...
            {/* ── Reminders (visible only when master on) ───────── */}
            {notifEnabled ? (
              <>
                {/* Section label */}
